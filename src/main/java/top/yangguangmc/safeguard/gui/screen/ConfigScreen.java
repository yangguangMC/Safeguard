...
public class ConfigScreen {
     ...
     * 检测项自身配置项、动作的成对专属配置项）。
     */
    private static <T> Option<?> buildDirectOption(ConfigOption<T> option, ResourceLocation ownerId, Component name) {
     ...
     */
    private static <T> Option<?> buildActionOption(ConfigOption<T> option, List<Action> instances, ResourceLocation ownerId, Component name) {
     ...
     */
    private static <T> OptionDescription buildOptionDescription(ConfigOption<T> option, ResourceLocation ownerId) {
