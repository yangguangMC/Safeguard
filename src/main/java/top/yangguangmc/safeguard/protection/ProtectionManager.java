...
public class ProtectionManager {
     ...
     */
    public String getDetectionOptionTranslationKey(Identifier id, String optionKey) {
     ...
     * 若语言文件中存在其 {@code .details} 后缀键，内容将作为补充说明（如性能警告）显示在描述面板中。
     */
    public String getActionOptionTranslationKey(Identifier id, String optionKey) {
     ...
     * </p>
     */
    public List<Action> getActionInstances(Identifier id) {
