...
public class PauseAction extends Action {
    ...
    public void pause(Minecraft client) {
        if (!client.isLocalServer()) {
            client.getToastManager().addToast(new SystemToast(ModContext.SAFEGUARD_PAUSE_UNAVAILABLE, Component.translatable("messages.safeguard.name"), Component.translatable("action.safeguard.active.afk.pause.unavailable")));
        ...
        client.getToastManager().addToast(new SystemToast(ModContext.SAFEGUARD_PAUSE, Component.translatable("messages.safeguard.name"),
