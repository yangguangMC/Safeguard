...
- 移除 `## License`
- 移除文章内嵌的 Icon
- 替换所有引用的仓库内容的链接，还有 `## Dependencies` 的 Modrinth
...
| Type        | Name                                                                  | Version   |
|-------------|-----------------------------------------------------------------------|-----------|
| Required    | [Fabric API](https://www.curseforge.com/minecraft/mc-mods/fabric-api) | ≥ 0.141.4 |
| Required    | [YACL](https://www.curseforge.com/minecraft/mc-mods/yacl)             | ≥ 3.8.2   |
| Recommended | [Mod Menu](https://www.curseforge.com/minecraft/mc-mods/modmenu)      | ≥ 17.0.0  |
